    ...
    <div class="container-lg">
        <div class="row">
            <div class="col">
                ...
                <div class="Images">
                    <img src="http://localhost/LR2WEB1/Img/1.jpg" href="#" alt="img-thumbnail">
                </div>
            ...
            <div class="col">
                <div class="Fornavbar" style="color: black;">
                    <nav class="nav nav-pills nav-fill" style="background-color: #f5f5f5fd">
                        ...
                        <a class="nav-link" href="http://localhost/LR2WEB1/index2.html">По цвету ˅</a>
            ...
            <div class="col">
                <form>
                    <div class="form-group mt-2">
                        ...
                        <input class="form-control" name="gameNamefilter" placeholder="Введите ФИО усопшего"
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input class="form-control" name="peoplefilter" placeholder="Введите количество людей"
                            value="<?php if (isset($_GET['peoplefilter']))
                                echo $_GET['peoplefilter']; ?>">
                    </div>
