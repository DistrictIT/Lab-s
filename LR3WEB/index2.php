    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse show" id="navbarNavAltMarkup">
            ...
            <div class="Twonavbar-nav">
                <a class="nav-link" href="enter.php" tabindex="-1" aria-disabled="true">Войти</a>
                <a class="nav-link" href="register.php" tabindex="-1" aria-disabled="true">Регистрация</a>
            </div>
    ...
    <div class="container-lg">
        <div class="row">
            <div class="col">
                ...
                <div class="Images">
                    <img src="http://localhost/LR2WEB/Images/1.jpg" href="http://localhost/LR2WEB/input2.html"
                        alt="img-thumbnail">
                </div>
            ...
            <div class="col">
                <div class="Fornavbar" style="color: black;">
                    <nav class="nav nav-pills nav-fill" style="background-color: #f5f5f5fd">
                        <a class="nav-link " href="../LR3WEB/LR2.php">Поиск в архиве</a>
