<?php
session_start();
require_once 'logic/games_logic.php';
?>
...
<body>
  ...
  <div class="container-lg">
        ...
        <div class="card">
          <div class="row">
            <div class="col-5 col-sm-4">
              <img src="http://localhost/LR2WEB/Images/2.jpg" class="img-fluid w-50 align-items-start"
    ...
    <div class="row  justify-content-md-center">
      ...
      <div class="col-sm-4">
        <img src="http://localhost/LR2WEB/Images/3.jpg" class="img-thumbnail" alt="img-thumbnail">
      </div>

      <div class="col-sm-4">
        <img src="http://localhost/LR2WEB/Images/4.jpg" class="img-thumbnail" alt="img-thumbnail">
      </div>

      <div class="col-sm-3">
        <img src="http://localhost/LR2WEB/Images/5.jpg" class="img-thumbnail" alt="img-thumbnail">
      </div>
    </div>
